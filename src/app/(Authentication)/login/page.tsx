"use client";
//HighTODO: Add proper validation.
        ...
        <div className="flex justify-center items-center h-screen">
            ...
            >
                <div>
                    ...
                    <div
                        className="w-full border-2 border-[#D9D9D9] text-secondary flex justify-center items-center rounded-lg mt-6 p-1 cursor-pointer"
                    ...
                    <form className="space-y-6" onSubmit={handleLogin} noValidate>
                        <div className="space-y-4">
                            <div>
                                <Input
                                    ...
                                    className={`w-full px-4 py-2 rounded-md border-gray-300 focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 transition duration-150 ease-in-out ${error ? "border-red-500" : ""
                                        }`} // Error border
                                    icon={
                                        <Icon
                        ...
                        <div>
                            <Button
                                ...
                                disabled={
                                    loading || (step === 1 && !email) || (step === 2 && !password)
                                }
                            >
                                {loading ? (
                                    <Icon
