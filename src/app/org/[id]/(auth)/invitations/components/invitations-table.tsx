// src/app/org/[id]/(auth)/invitations/components/invitations-table.tsx
'use client';
...
export default function InvitationsTable() {
  ...
  const fetchInvitations = async () => {
    ...
    setError(null);
    try {
      const response = await fetchWrapper(`${process.env.NEXT_PUBLIC_API_URL}/invitation/get-invitation?organization_id=${org_id}&action=get-invitation`, {
        credentials: 'include',
        method: 'GET',
        headers: {
