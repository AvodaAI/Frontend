...
export default function LoginPage() {
  ...
  const [result, wrappedAction, pending] = useActionState(loginAction, {
    error: undefined,
    redirect: undefined,
  });
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2 w-full">
        <Button
          variant="outline"
          onClick={() => wrappedAction(new FormData(), { social: "github" })}
          disabled={pending}
        >
        ...
        <Button
          variant="outline"
          onClick={() => wrappedAction(new FormData(), { social: "google" })}
          disabled={pending}
        >
